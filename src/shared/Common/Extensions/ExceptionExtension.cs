...
namespace Microsoft.Azure.CCME.Assessment.Extensions
{
    ...
    public static class ExceptionExtension
    {
        ...
        private static void PrintWebException(StringBuilder stringBuilder, WebException webException)
        {
            ...
            var headers = webResponse.Headers.AllKeys.ToDictionary(key => key, key => webResponse.Headers[key]);
            var headerJson = JsonConvert.SerializeObject(headers, Formatting.Indented);
